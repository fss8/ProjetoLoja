...
export default function NovoProduto() {
  ...
  const handleSubmit = (event) => {
    ...
    APIService.InserirProd({nome, tipo, descricao, valor, userid:user.id, linhaespecifica:''})
    .then(resp => {
        //console.log(resp)
        if(resp === true){
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6 text-gray-900">Anunciar um produto</h3>
